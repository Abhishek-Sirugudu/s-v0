...
import { FaPlus, FaVideo, FaFileAlt, FaArrowRight, FaArrowLeft, FaSave, FaTrash, FaCheck, FaArrowUp, FaArrowDown, FaInfoCircle } from 'react-icons/fa';
                    ...
                    {step === 1 && (
                        <div className="w-full">
                            ...
                            <div className="mt-10 flex justify-end">
                                ...
                                >
                                    Proceed to Curriculum <FaArrowRight size={12} />
                                </button>
                            </div>
                        </div>
                    )}
                                            ...
                                            courseData.modules.map((m, idx) => (
                                                <div key={m.id} className="bg-white p-3 rounded-md border border-slate-200 flex items-center justify-between group hover:border-indigo-200 transition-colors">
                                                    ...
                                                    <div className="flex items-center gap-2 opacity-0 group-hover:opacity-100 transition-opacity">
                                                        <button onClick={() => moveModule(idx, -1)} disabled={idx === 0} className="p-1.5 text-slate-400 hover:text-indigo-600 hover:bg-indigo-50 rounded"><FaArrowUp size={12} /></button>
                                                        <button onClick={() => moveModule(idx, 1)} disabled={idx === courseData.modules.length - 1} className="p-1.5 text-slate-400 hover:text-indigo-600 hover:bg-indigo-50 rounded"><FaArrowDown size={12} /></button>
                                                        <button onClick={() => removeModule(m.id)} className="p-1.5 text-slate-400 hover:text-rose-600 hover:bg-rose-50 rounded"><FaTrash size={12} /></button>
                                                    </div>
                                                </div>
                                            ))
                                        )}

                                        ...
                                        <div className="space-y-1.5">
                                            ...
                                            <div className="flex gap-2">
                                                <input
                                                    ...
                                                    className={`w-20 px-3 py-2 border border-slate-200 rounded-md focus:border-indigo-500 outline-none text-sm ${formData.linkedCourseId ? 'bg-slate-100 text-slate-400' : 'bg-white'}`}
                                                />
                                                <select
                                                    name="validityUnit"
                                                    ...
                                                    onChange={handleInputChange}
                                                    disabled={!!formData.linkedCourseId}
                                                    className={`flex-1 px-3 py-2 border border-slate-200 rounded-md focus:border-indigo-500 outline-none text-sm ${formData.linkedCourseId ? 'bg-slate-100 text-slate-400' : 'bg-white'}`}
                                                >

...
const CoursePlayerView = ({
    ...
    isModuleCompleted, handleMarkComplete,
    navigate, courseId
}) => {
                ...
                <div className="flex-1 flex flex-col relative bg-black">
                        ...
                        {currentModule?.type === 'video' ? (
                            (currentModule.url.includes('firebasestorage') || currentModule.url.match(/\.(mp4|webm|ogg)$/)) ? (
                                ...
                                <iframe
                                    ...
                                    src={currentModule.url.includes('youtube') && !currentModule.url.includes('embed')
                                        ? currentModule.url.replace('watch?v=', 'embed/')
                                        : currentModule.url}
                                    title="Video Player"
                                    frameBorder="0"
                    ...
                    <div className="h-20 bg-slate-800 border-t border-slate-700 flex items-center justify-between px-8 flex-shrink-0">
                        <div>
                            ...
                            <p className="text-sm text-slate-400">{currentModule?.type === 'video' ? 'Video Lesson' : 'Reading Material'}</p>
                        </div>
                        <button
                            ...
                            return (
                                ...
                                >
                                    ...
                                    <div className="flex gap-3">
                                        ...
                                        <div>
                                            <h5 className={`text-sm font-medium mb-1 leading-snug ${isActive ? 'text-white' : 'text-slate-300 group-hover:text-white'
                                                }`}>
                                                {module.title}
                                            </h5>
